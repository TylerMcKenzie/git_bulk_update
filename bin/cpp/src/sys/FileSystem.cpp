...
HX_LOCAL_STACK_FRAME(_hx_pos_b4db2871ee22ed2c_88_readDirectory,"sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","/usr/share/haxe/std/cpp/_std/sys/FileSystem.hx",88,0xcabeeced)
namespace sys{
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_b4db2871ee22ed2c_88_readDirectory)
HXDLIN(  88)		return _hx_std_sys_read_dir(path);
            	}
